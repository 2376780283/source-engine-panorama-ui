...
{
public:
	virtual bool BPresentYUV420Texture( uint nWidth, uint nHeight, void *pPlaneY, void *pPlaneU, void *pPlaneV, uint unStrideY, uint unStrideU, uint unStrideV ) = 0;
};
...
public:
	...
	virtual void SuggestMaxVeritcalResolution( int nHeight ) = 0;
...
LIBVIDEO_INTERFACE void VideoValidate( CValidator &validator, const tchar *pchName );
